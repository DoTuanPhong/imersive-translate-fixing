...
(function () {
    ...
    // to hide our hooks from detection by anti-debug scripts.
    {
        ...
        // Firefox/Tampermonkey uses eval to inject site scripts; wrapping it makes
        // those eval calls indirect and breaks obfuscated player code that relies
        // on local variables from the caller scope.
        if (!isFirefox) {
