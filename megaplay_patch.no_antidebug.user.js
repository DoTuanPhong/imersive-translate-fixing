...
// @version      11.6.5
// @description  Pure IT engine fix without anti-debug hooks: fetch override + Referer injection + postMessage interception + shadow-aware translation sync guard + stale-loading & untranslated-cue recovery + iframe relay. Visual Console. No Google fallback. Expanded site coverage.
// @author       Antigravity
// @match        *://anisuge.tv/*
// @match        *://anisuge.se/*
// @match        *://animesuge.re/*
